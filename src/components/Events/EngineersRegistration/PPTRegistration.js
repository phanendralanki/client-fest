        ...
        <div className="row justify-content-center align-items-center">
          <div className="col-lg-6">
            <h1 className="fw-bold text-center text-success mb-4">
              OFFLINE GAMES Registration
            </h1>
            <form onSubmit={postPPT}>
              <div className="mb-3">
              ...
              <div className="mb-3">
                ...
                <div className="form-check">
                  <input
                    ...
                    type="checkbox"
                    name="chess"
                    checked={formData.interestedGames.chess}
                    onChange={handleChange}
                  />
                ...
                <div className="form-check">
                  <input
                    ...
                    type="checkbox"
                    name="sudoku"
                    checked={formData.interestedGames.sudoku}
                    onChange={handleChange}
                  />
                  <label className="form-check-label">Sudoku</label>
                </div>
              </div>
