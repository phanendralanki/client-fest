...
const TechnicalEvents = () => {
  ...
  const postQuiz = async (e) => {
    ...
    try {
      // const response = await fetch("http://localhost:8080/api/technicalEvents/registerTechnicalEvent", {
      const response = await fetch(
        "https://server-fest.onrender.com/api/technicalEvents/registerTechnicalEvent",
        {
          method: "POST",
          headers: {
              ...
              <div className="mb-3">
                ...
                <div className="form-check">
                  <input
                    ...
                    type="checkbox"
                    name="ppt"
                    checked={formData.interestedGames.ppt}
                    onChange={handleChange}
                  />
                ...
                <div className="form-check">
                  <input
                    ...
                    type="checkbox"
                    name="quiz"
                    checked={formData.interestedGames.quiz}
                    onChange={handleChange}
                  />
                ...
                <div className="form-check">
                  <input
                    ...
                    checked={formData.interestedGames.posterPresentation}
                    onChange={handleChange}
                  />
                ...
                <div className="form-check">
                  <input
                    ...
                    type="checkbox"
                    name="projectExpo"
                    checked={formData.interestedGames.projectExpo}
                    onChange={handleChange}
                  />
                  <label className="form-check-label">Project Expo</label>
                </div>
                <div className="form-check">
                  <input
                    className="form-check-input"
                    type="checkbox"
                    name="spontaneousCompetition"
                    checked={formData.interestedGames.spontaneousCompetition}
                    onChange={handleChange}
                  />
                  <label className="form-check-label">
                ...
                <div className="form-check">
                  <input
                    ...
                    type="checkbox"
                    name="crazyOutput"
                    checked={formData.interestedGames.crazyOutput}
                    onChange={handleChange}
                  />
                  <label className="form-check-label">Crazy Output</label>
                </div>
              </div>
